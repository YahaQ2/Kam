        ...
        <section className="relative min-h-screen overflow-hidden pt-24 pb-16 md:py-32">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <Button
                asChild
                className="border-2 border-gray-100 bg-transparent text-yellow-900 hover:bg-gray-100/10 px-6 md:px-8 py-2.5 md:py-3 rounded-full transition-colors shadow-lg"
              >
