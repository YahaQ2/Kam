                    ...
                    {recentlyAddedMessages.map((msg, index) => (
                      ...
                      >
                        <div className="h-full w-full flex items-center justify-center">
                          <div className="w-full h-full max-w-[100px] mx-auto bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 overflow-hidden">
                            <CarouselCard 
                              to={msg.recipient || '-'} 
                              from={msg.sender || '-'} 
